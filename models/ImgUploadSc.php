...
class ImgUploadSc extends Model{
       ...
       if($this->validate())
       {
          ...
          // $this->deleteCurrentImage($currentImage);
           ...
           $filename = $this->generateFilename();
            ...
            $m=PodServiscatr::findOne($_GET['id']);
         //die($_SERVER['DOCUMENT_ROOT'].'/web/uploads/'.$m->imege);
            if (is_file($_SERVER['DOCUMENT_ROOT'].'/web/uploadsc/'.$m->imege)) {

                unlink($_SERVER['DOCUMENT_ROOT'].'/web/uploadsc/'.$m->imege);
            }
    ...
    {
        return $_SERVER['DOCUMENT_ROOT'].Yii::getAlias('@web') . '/uploadsc/';
    }
